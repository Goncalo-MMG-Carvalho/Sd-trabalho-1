...
public class GrpcUsersServerStub implements UsersGrpc.AsyncService, BindableService {
	...
	@Override
	public void getUser(GetUserArgs request, StreamObserver<GetUserResult> responseObserver) { //TODO DONE
	...
	@Override
	public void updateUser(UpdateUserArgs request, StreamObserver<UpdateUserResult> responseObserver) {//TODO DONE
	...
	@Override
    public void deleteUser(DeleteUserArgs request, StreamObserver<DeleteUserResult> responseObserver) {//TODO DONE
	...
	@Override
	public void searchUsers(SearchUserArgs request, StreamObserver<GrpcUser> responseObserver) {//TODO DONE
		var res = impl.searchUsers(request.getPattern());
	
		if(!res.isOK() ) 
			responseObserver.onError(errorCodeToStatus(res.error()));
		else {
			List<User> l = res.value();
